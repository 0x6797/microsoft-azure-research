...
- [サービス開発時にデバイスが用意できません。どうしたらいいですか？](#q12)
...
- [リーション障害が解消されたので、IoT Hub の実行リージョンを元に戻せますか？](#q-failback)
...
## <a id="q12">サービス開発時にデバイスが用意できません。どうしたらいいですか？</a>
...
このような標準のオプション以外にも、サービス利用者がリージョン間の高可用性を担保する設計／実装することもできます。
...
## <a id="q-failback">リーション障害が解消されたので、IoT Hub の実行リージョンを元に戻せますか？</a>
